...
const ContactSection = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Расположение студии',
      value: 'ул. Фото, 123, Москва',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Спасибо за ваше сообщение. Я свяжусь с вами как можно скорее.",
        duration: 5000,
      });
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-display font-semibold mb-4">Свяжитесь со мной</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Планируете проект или хотите заказать фотосессию? Отправьте мне сообщение, и я свяжусь с вами как можно скорее.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="bg-secondary/50 dark:bg-gray-900 rounded-xl p-8 h-full flex flex-col">
                <h3 className="font-display text-xl mb-6">Контактная информация</h3>
                ...
                <div className="mt-auto pt-6 border-t border-border">
                  <p className="text-sm text-muted-foreground mb-4">Следите за мной в социальных сетях</p>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-sm border border-border">
                <h3 className="font-display text-xl mb-6">Отправить сообщение</h3>
                ...
                {isSubmitted ? (
                  <div className="text-center py-12">
                    ...
                    <h4 className="text-xl font-medium mb-2">Спасибо!</h4>
                    <p className="text-muted-foreground">Ваше сообщение успешно отправлено.</p>
                  </div>
                ) : (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="Portrait Session">Портретная съемка</option>
                          <option value="Wedding Photography">Свадебная фотография</option>
                          <option value="Commercial Work">Коммерческая работа</option>
                          <option value="Other Inquiry">Другой вопрос</option>
                        </select>
                      </div>
                    </div>
